...
Aktualna wersja: **v.4.2.0 beta "Lemon Tart"**
Autor: **TiedWithType**
...
- 🎨 Zmiana kolorów markerów **O** i **X** przez spójny picker z presetami i HEX.
...
Komponenty Web Components z własnymi template'ami, stylami Shadow DOM i lokalną logiką renderowania. Wspólna baza `Component` obsługuje render przez template, interpolację `{{ expression }}` oraz aktualizacje interpolowanych tekstów i atrybutów:
...
- `color-picker` - spójny picker koloru markerów z presetami, HEX i lokalnym reducerem
...
- ✅ color picker rozwija się spójnie na desktopie i mobile, przyjmuje HEX oraz zmienia markery, start button i glow tytułu
